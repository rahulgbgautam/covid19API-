        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto pl-4">
				...
				<li class="nav-item active">
                    <a class="nav-link" href="#">India Day Wise</a>
                </li>
                <li class="nav-item">
            ...
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" onkeyup="searchfun()" id="myInput">
        ...
        <div class="row" w-100 h-100>
            ...
            <div class="col-lg-5 col-md-5 col-12 order-lg-1 oder-2 p-2">
                <div class="leftside w-100 h-100 d-flex justify-content-center align-items-center">
                    <img src="images/24.jpg" height="300" width="530">
                </div>
            </div>

            <div class="col-lg-7 col-md-7 col-12 order-lg-2 oder-1">
                <div class="rightside w-100 h-100 d-flex justify-content-center align-items-center text-success">
...
$tc = count($daywise['cases_time_series']); // total countries
...
while($i<$tc){
	...
	<tr>	
			<th class="text-left"> Date And Month </th>
			<th colspan="5"></th>	
	</tr>
	
	<tr>
		<td colspan="6" class="text"> <?php echo $daywise['cases_time_series'][$i]['date']."</br>" ;?></td>
	
	</tr>
	
	<tr class="text-capitalize text-white">

				<th style="color:#fff; background:#2196f3;"> dailyconfirmed </th>
				<th style="color:#fff; background:#2196f3;"> dailydeceased </th>
				<th style="color:#fff; background:#2196f3;"> dailyrecovered </th>
				<th style="color:#fff; background:#2196f3;"> totalconfirmed </th>
				<th style="color:#fff; background:#2196f3;"> totaldeceased </th>
				<th style="color:#fff; background:#2196f3;"> totalrecovered </th>			
...
<!------------------------  Top Cursor  -------------------------------->
	...
	<footer class="mt-5 ml-2" style="background-color:#2196f3";>
